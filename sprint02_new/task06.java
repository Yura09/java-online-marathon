...
class MyUtils {
    public List<Shape> maxAreas(List<Shape> shapes) {
        ...
        return shapes.stream().filter(shape -> Double.compare(shape.getArea(), longestCircleArea) == 0 ||
                Double.compare(shape.getArea(), longestCRectangleArea) == 0).collect(Collectors.toList());
    }
}
